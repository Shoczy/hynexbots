...
const client = new Client({
  intents: [
    ...
    GatewayIntentBits.MessageContent, // privileged — for prefix commands & autoresponses
    GatewayIntentBits.GuildMembers, // privileged — for welcome/auto-roles & whitelist
  ],

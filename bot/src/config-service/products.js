...
const KNOWN_TABS = ['basics', 'modules', 'messages', 'commands', 'moderation', 'tickets', 'economy', 'music'];
const ALL_MODULES = ['moderation', 'welcome', 'economy', 'music', 'tickets', 'leveling'];
...
const COMMAND_GROUPS = [
  { id: 'moderation', commands: ['ban', 'kick', 'mute', 'unmute', 'warn', 'warnings', 'purge', 'lockdown'] },
...
const TEMPLATES = {
  moderation: {
    tabs: ['basics', 'moderation', 'commands'],
    modules: ['moderation'],
    commandGroups: ['moderation', 'utility'],
  },
  tickets: {
    tabs: ['basics', 'tickets', 'commands'],
    modules: ['tickets'],
    commandGroups: ['tickets', 'utility'],
  },
  economy: {
    tabs: ['basics', 'economy', 'commands'],
    modules: ['economy'],
    commandGroups: ['economy', 'utility'],
  },
  music: {
    tabs: ['basics', 'music', 'commands'],
    modules: ['music'],
    commandGroups: ['music', 'utility'],
  },
...
function featuresFromModules(moduleKeys) {
  ...
  return { tabs: ALL_TABS, modules: mods, commandGroups: groups };
}

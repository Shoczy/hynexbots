...
export default function EditorPage() {
  ...
  return (
    <>
      <TopBar />
      <main className="mx-auto w-full max-w-[1600px] px-6 py-10 xl:px-10">
      ...
      {tab !== 'team' && tab !== 'logs' && tab !== 'analytics' && tab !== 'license' && (
        <div className="sticky bottom-0 z-30 border-t border-ink-700/60 bg-ink-950/80 backdrop-blur-xl">
          <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between px-6 py-4 xl:px-10">
            <p className="text-sm text-mist-muted">
              {saved ? (

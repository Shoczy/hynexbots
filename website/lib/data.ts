...
export const bots: Bot[] = [
  {
    ...
    category: 'Security',
    price: '€10',
    blurb: 'A hardened server guardian: anti-nuke, raid defense, smart auto-mod, a verification gate, and onboarding.',
    features: [
      'Anti-nuke — stop rogue/compromised admins',
      'Anti-raid & spam protection',
      'Auto-mod with warns, mutes, kicks & bans',
      'Verification gate & self-assign roles',
      'Welcome, auto-roles & full audit logging',
      'Hosting included',
    ],
  ...
  },
  {
    ...
    category: 'FiveM',
    price: '€8',
    blurb: 'Built for FiveM servers: a live status board, role whitelist, in-game reports, and restart announcements.',
    features: [
      'Live server status & player count',
      'Whitelist via a Discord role',
      'In-game reports forwarded to Discord',
      'Scheduled restart announcements',
      'Welcome & auto-roles',
      'Hosting included',
    ],

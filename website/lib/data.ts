...
export const bots: Bot[] = [
  {
    id: 'moderation',
    name: 'Sentinel',
    category: 'Server Guardian',
    price: '$49',
    blurb: 'An all-in-one server guardian: smart auto-mod, raid defense, a verification gate, and member onboarding.',
    features: [
      'Auto-mod, anti-raid & spam protection',
      'Warns, mutes, kicks & bans',
      'Verification gate & auto-roles',
  ...
  },
  {
    ...
    price: '$39',
    blurb: 'A complete support suite: polished tickets, application forms, an auto-answering FAQ, and onboarding.',
    features: [
      'Multi-panel tickets & transcripts',
      'Application forms with approve/deny',
      'Auto-answering FAQ',
      'Welcome & auto-roles',
      'Claim & staff workflow',
      'Hosting included',
    ],
  ...
  },
  {
    id: 'economy',
    name: 'Vault',
    category: 'Engagement Economy',
    price: '$59',
    blurb: 'Drive engagement with a deep economy, leveling, and automated giveaways.',
    features: [
      'Currency, shop & gambling',
      'Daily/weekly rewards & robbing',
  ...
  },
  {
    ...
    price: '$45',
    blurb: 'Crystal-clear audio with saved playlists, voice leveling, and 24/7 playback.',
    features: [
      'HD audio, queue & filters',
      'Saved playlists',
